        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <SectionCard
              ...
              description="Current certification challenges"
            />
            <SectionCard
              title="Our Solution"
              description="VeganFriends DAO platform overview"
            />
            <SectionCard
              title="How It Works"
            ...
            <SectionCard
              title="Benefits"
              description="Value for all stakeholders"
            />
            <SectionCard
              title="Technology"
              description="NEAR, OnSocial, Smart Contracts"
            />
            <SectionCard
              title="Roadmap"
              description="Q1 2025 through 2026 vision"
            />
            <SectionCard

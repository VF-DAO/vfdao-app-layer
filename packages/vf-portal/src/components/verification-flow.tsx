...
import { Leaf, FlaskConical, Shield, Link2, Package, Store, CheckCircle } from 'lucide-react'
...
export function VerificationFlow() {
  ...
  const getStageScale = (stagePosition: number) => {
    ...
    if (distance < 10) {
      ...
      return 1 + (scaleFactor * 0.15) // Smooth scale from 1.15 to 1
    } else {
      return 1
    }
  }
      ...
      <div className="relative">
        <div className="grid grid-cols-7 gap-2 sm:gap-4">
          {stages.map((stage) => {
            ...
            const isActive = distance < 10 && !(stage.position === 0 && progress > 90) && !(stage.position === 100 && progress < 10)
            ...
            return (
              ...
              >
                ...
                <div 
                  ...
                  `}
                  style={{
                    transition: 'border-color 600ms ease-out, background-color 600ms ease-out, box-shadow 600ms ease-out',

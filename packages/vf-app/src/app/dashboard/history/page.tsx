...
export default function HistoryPage() {
  return (
    <div className="p-8">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-2">Verification History</h1>
      ...
      <div className="rounded-2xl border-2 border-dashed border-border bg-muted/30 p-12 text-center">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-2">No Verifications Yet</h2>
